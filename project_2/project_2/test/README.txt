...
* Unzip, Compile, Execute, and Control project_1: Instructions:
	...
	* Control Flow of FTP service:
		...
		6. server will accept this new connection to the client
		7. server will create a control connection with the client (for basic communication)
		8. server will open a data connection with the client (for FTP)
		9. server will receive and display client's command (either list files or deliver a specified file within that server's directory
		10. client connection will end, server will remain open
		11. server can be shut down via Ctrl-c
